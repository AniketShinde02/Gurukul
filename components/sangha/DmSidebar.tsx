...
export function DmSidebar({ onSelect }: { onSelect?: (id: string) => void }) {
    const { conversations, activeConversationId, setActiveConversationId, deleteConversation } = useDm()
